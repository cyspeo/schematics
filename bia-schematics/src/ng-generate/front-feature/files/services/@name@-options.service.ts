...
import { getAll@Name@TypeOptions } from 'src/app/domains/@name@-type-option/store/@name@-type-option.state';
import { loadAll@Name@TypeOptions } from 'src/app/domains/@name@-type-option/store/@name@-type-options-actions';
...
export class @Name@OptionsService {
    ...
    constructor(
        ...
        this.@name@TypeOptions$ = this.store.select(getAll@Name@TypeOptions);
    ...
    loadAllOptions() {
        this.store.dispatch(loadAll@Name@TypeOptions());
